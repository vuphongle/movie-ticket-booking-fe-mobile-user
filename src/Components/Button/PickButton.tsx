import { PickView } from "../PickView/PickView";
import { PickText } from "../PickText/PickText";
...
export const PickButton = React.forwardRef((props: IButtonProps, ref: React.Ref<ViewType>) => {
  const { buttonSize, colors, scale, radius, spacing } = useThemedStyles();
  const {
    title,
    onPress,
    style,
        ...
        {loading ? (
          ...
          >
            ...
            {typeof title == "string" ? (
              <PickText
                style={[
                  isPressed ? styleButton[type].text.click : styleButton[type].text.default,
                  isDisabled ? styleButton[type].text.disabled : styleButton[type].text.default,
                  textStyle,
                ]}
              >
                {title}
